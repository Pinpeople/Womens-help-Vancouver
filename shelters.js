// docs/shelters.js
// NOTE: Double-check phone/email/hours before sharing publicly.
window.SHELTERS = [
  {
  ...
  },
  {
    ...
    type: "Shelter",
    notes: "Year-round, low-barrier, 24-hour emergency housing for adults 19+. 40 male beds / 10 female beds (incl. cis & trans).",
  ...
  },
  {
    name: "Powell Place",
    type: "Shelter",
    notes: "24-hour intake listed on bc211 (verify availability).",
    address: "329 Powell Street, Vancouver, BC V6A 1G5",
    phone: "604-606-0403",
    email: "powellplace@thebloomgroup.org"
  },
  {
    name: "Beacon Hotel (PHS)",
    type: "Housing",
    notes: "Single room occupancy (SRO) social housing for individuals living with concurrent disorders.",
